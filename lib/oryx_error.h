...
*   1 June, 2015
*   Func: Standard Error Definition
*   Personal.Q
*/

#ifndef __ORYX_GENERIC_ERRNO_BASE_H__
#define __ORYX_GENERIC_ERRNO_BASE_H__
...
extern const char * oryx_err2string(int error);
extern const char * oryx_safe_strerror(int no);
extern char * oryx_strerror(oryx_status_t statcode, char *buf,
                                 oryx_size_t bufsize);
